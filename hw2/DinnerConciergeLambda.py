...
def greeting_intent(intent_request):
    ...
    # if intent_request['invocationSource'] == 'DialogCodeHook':
    #     # Validate any slots which have been specified.  If any are invalid, re-elicit for their value
    #     # validation_result = validate_plan(intent_request['currentIntent']['slots'])
    #     # if not validation_result['isValid']:
    #     #     slots = intent_request['currentIntent']['slots']
    #     #     slots[validation_result['violatedSlot']] = None
...
def dine_intent(intent_request):
    """
    Performs dialog management and fulfillment for booking a car.
...
def dispatch(intent_request):
    ...
    if intent_name == 'BookHotel':
        ...
        return dine_intent(intent_request)
